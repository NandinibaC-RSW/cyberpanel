...
fileManager.controller('fileManagerCtrl', function ($scope, $http, FileUploader, $window) {
    ...
    var resolvedHomePath = $("#homePathInitial").text() || ("/home/" + domainName);

    var homePathBack = resolvedHomePath;
    $scope.currentPath = resolvedHomePath;
    $scope.startingPath = domainName;
    $scope.completeStartingPath = resolvedHomePath;
