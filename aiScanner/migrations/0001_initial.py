# Generated by Django 4.2.14 on 2026-09-17 10:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ScannerFileOperation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scan_id', models.CharField(db_index=True, max_length=255)),
                ('operation', models.CharField(choices=[('backup', 'Backup'), ('read', 'Read'), ('replace', 'Replace'), ('rename', 'Rename'), ('delete', 'Delete')], max_length=20)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['scan_id', 'created_at'], name='scanner_fil_scan_id_38663f_idx')],
            },
        ),
        migrations.CreateModel(
            name='ScannerAPIRateLimit',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['scan_id', 'endpoint'], name='scanner_api_scan_id_fbea4b_idx')],
